...
<h1>Удаление отделов на предприятии</h1>
    <form action="<c:url value="/deldepartament"/>"method="post">
    <div>
    <label for="iddep">ID отдела</label>
...
<div>
<table >
<caption><b><i>Вы удалили отдел на предприятии</i></b></caption>
<thead>
<tr>
<th>id отдела</th>
...
<tbody><c:forEach items="${departaments}" var = "d">
<tr>
<td>${d.getIdDep()}</td>
<td>${d.getNameDep()}</td>
</tr>
